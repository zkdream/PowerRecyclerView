 ...
 * @filename LoadRefreshRecyclerView
 * @date on 2017\12\21 0021 16:15
...
//    当前是否正在拖动
    ...
    // 正在刷新状态
    private int LOAD_STATUS_LOADING = 0x0044;
    ...
    private void restoreLoadView() {
        final int currentBottomMargin=((MarginLayoutParams)mLoadView.getLayoutParams()).bottomMargin;
